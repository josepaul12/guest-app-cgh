  ...
  return (
    <div className="curated-experiences-page">
      ...
      <div className="curated-experiences-topbar">
        ...
        <button className="curated-experiences-call-button" aria-label="Call" onClick={() => window.location.href = 'tel:+918071700830'}>
      ...
      <div className="curated-experiences-content">
        {fishingVillageExperiences.map((experience) => (
          <div 
            ...
            onClick={experience.id === 1 ? () => navigate('/fishing-village-tour') : undefined}
