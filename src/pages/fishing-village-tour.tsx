...
const FishingVillageTour: React.FC = () => {
  ...
  return (
    <div className="fishing-village-tour-page">
      ...
      <div className="fishing-village-tour-topbar">
        <button className="fishing-village-tour-back-button" onClick={() => navigate(-1)} aria-label="Back">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 12H5M5 12L12 19M5 12L12 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        <h1 className="fishing-village-tour-title">fishing village</h1>
        <button className="fishing-village-tour-call-button" aria-label="Call" onClick={() => window.location.href = 'tel:+918071700830'}>
