  ...
  return (
    <div className="chakara-page">
      ...
      <div className="chakara-topbar">
        <button className="chakara-back-button" onClick={() => navigate(-1)} aria-label="Back">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 12H5M5 12L12 19M5 12L12 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        <h1 className="chakara-title">Chakara</h1>
        <button className="chakara-call-button" aria-label="Call" onClick={() => window.location.href = 'tel:+918071700830'}>
